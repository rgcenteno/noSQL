...
- Optimizados para lectura/escritura masiva.
- Menos estrictas en el cumplimiento del modelo ACID.
- Priorizan disponibilidad y tolerancia a particiones sobre Consistencia dentro del [teorema CAP](https://aitor-medrano.github.io/iabd/sa/nosql.html#teorema-de-cap).
- Admite datos estruturados, semi-estruturados e non estruturados  
- Flexibilidade no esquema (Esquemas dinámicos)  
...
A maioría de sistemas NoSQL soportan replicación automática o que nos permite unha alta disponibilidade e recuperación contra desastres sen a necesidade de software de terceiros.

A replicación mantén copias idénticas dos datos en múltiples servidores. Isto facilita que as aplicacións funcionen e os datos se manteñan seguros incluso cando algúns nodos non están dispoñibles. Grazas á replicación tamén podemos acadar:

- **Escalabilidade**: Pódense distribuir as consultas aos nodos con menor carga debido á redundancia de datos.
- **Disponibilidade**: Ao ter os datos replicados un nodo secundario pode tomar o control en caso de caída do nodo principal.
- **Illamento**: Podemos facer operacións costosas de lectura nos nodos secundarios sen que teñan impacto no nodo principal.
