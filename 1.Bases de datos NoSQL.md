...
Estrategia de escalado horizontal donde los datos se asignan a fragmentos específicos (shards) basándose en una lista de valores discretos predefinida. A diferencia del caso anterior, esta técnica agrupa registros que comparten atributos específicos. Ejemplo:
...
- Control sobre donde va cada dato
- Muy útil para criterios de negocio (tipos de cliente, ubicación de almacenes...)
- Permite aislar cargas

#### Desventajas

- No escala bien si aparecen muchos valores nuevos.
- Poco flexible si cambian los valores que usamos para categorizar.
